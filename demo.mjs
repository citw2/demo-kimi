#!/usr/bin/env node
// SAIHM memory for Kimi — one client-side-encrypted memory you own; provable forget.
//
//   git clone https://github.com/citw2/demo-kimi
//   cd demo-kimi && npm install && node demo.mjs
//
// Optional, for a LIVE Kimi answer instead of the offline mock:
